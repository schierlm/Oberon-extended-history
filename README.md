...
* Module loader resolves all references to external procedures and global module data at module load time (see http://github.com/andreaspirklbauer/Oberon-fast-access-to-global-module-data), thereby eliminating the need for a  static base register and a global module table
