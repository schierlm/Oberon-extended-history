...
* Module loader resolves all references to external procedures and data at module load time (see variant 2 of http://github.com/andreaspirklbauer/Oberon-fast-access-to-global-module-data)
